...
public class ShoppingCart {
    ...
    public void addToCart(Products product, Manager manager, String category) {
        if (product != null) {
            devices.add(product);
            manager.removeProduct(product, category);
            System.out.println(product.getProduct_name() + " has been added to your cart.");
        }
    }
